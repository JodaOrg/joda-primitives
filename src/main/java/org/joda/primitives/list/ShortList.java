 ...
 * @since 1.0
 */
public interface ShortList extends PrimitiveList, ShortCollection {
     ...
     * @throws IndexOutOfBoundsException if either index is invalid
     */
    ShortList subShortList(int fromIndexInclusive, int toIndexExclusive);
     ...
     * collection cannot be added to.
     *
     * @deprecated use short removeShortAt(int) (will remain as in List interface)
