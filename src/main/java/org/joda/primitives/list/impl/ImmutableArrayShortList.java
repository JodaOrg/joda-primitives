...
/**
 * Immutable array-based implementation of <code>ShortList</code> for
...
public final class ImmutableArrayShortList extends AbstractShortList {
     ...
     */
    public static ImmutableArrayShortList copyOf(short[] values) {
        if (values == null) {
            return EMPTY;
        } else {
            return new ImmutableArrayShortList(values.clone());
        }
    }
     ...
     * @return the created list, not null
     */
    public static ImmutableArrayShortList copyOf(Collection<Short> coll) {
        if (coll == null) {
            return EMPTY;
        } else if (coll instanceof ImmutableArrayShortList) {
            return (ImmutableArrayShortList) coll;
        } else {
            return new ImmutableArrayShortList(ShortUtils.toPrimitiveArray(coll));
        }
    }
     ...
     */
    private ImmutableArrayShortList(short[] values) {
        super();
        data = values;
    }
