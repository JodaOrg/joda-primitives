...
/**
 * Array based implementation of <code>ShortList</code> for
 ...
 * @since 1.0
 */
public class ArrayShortList extends AbstractShortList implements Cloneable {
     ...
     */
    public ArrayShortList(short[] values) {
        super();
        if (values == null) {
            iData = ShortUtils.EMPTY_SHORT_ARRAY;
        } else {
     ...
     */
    public ArrayShortList(Collection<Short> coll) {
        super();
        if (coll == null) {
            iData = ShortUtils.EMPTY_SHORT_ARRAY;
        } else if (coll instanceof ArrayShortList) {
            ArrayShortList c = (ArrayShortList) coll;
            this.iData = new short[c.iSize];
     ...
     */
    public Object clone() {
        ArrayShortList cloned = (ArrayShortList) super.clone();
