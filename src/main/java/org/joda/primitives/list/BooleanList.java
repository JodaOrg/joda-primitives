...
/**
 * Defines a list of primitive <code>boolean</code> values.
 * <p>
 * This interface extends {@link java.util.List List} allowing seamless integration
 * with other APIs.
 * All List methods can be used, using the primitive wrapper class {@link Boolean}.
 ...
 * @since 1.0
 */
public interface BooleanList extends PrimitiveList, BooleanCollection {
     ...
     * @throws IndexOutOfBoundsException if either index is invalid
     */
    BooleanList subBooleanList(int fromIndexInclusive, int toIndexExclusive);
     ...
     * collection cannot be added to.
     *
     * @deprecated use boolean removeBooleanAt(int) (will remain as in List interface)
