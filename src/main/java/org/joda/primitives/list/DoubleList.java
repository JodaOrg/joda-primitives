 ...
 * @since 1.0
 */
public interface DoubleList extends PrimitiveList, DoubleCollection {
     ...
     * @throws IndexOutOfBoundsException if either index is invalid
     */
    DoubleList subDoubleList(int fromIndexInclusive, int toIndexExclusive);
     ...
     * collection cannot be added to.
     *
     * @deprecated use double removeDoubleAt(int) (will remain as in List interface)
