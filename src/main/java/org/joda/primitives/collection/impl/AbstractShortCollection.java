...
/**
 * Abstract base class for collections of primitive <code>short</code> elements.
 * <p>
 ...
 * To make the subclass modifiable, the <code>add(short)</code> and
...
public abstract class AbstractShortCollection
     ...
     */
    public boolean containsAll(short startInclusive, short endInclusive) {
     ...
     */
    public boolean containsAny(short startInclusive, short endInclusive) {
        if (startInclusive > endInclusive) {
            return false;
        }
        for (short i = startInclusive; i <= endInclusive; i++) {
     ...
     */
    public short[] toShortArray(short[] array, int startIndex) {
        if (startIndex < 0) {
        ...
        if (array == null) {
            // create new
            result = new short[startIndex + size()];
     ...
     * <p>
     * This implementation uses <code>add(short)</code>.
     *
     ...
     * @throws UnsupportedOperationException if not supported by this collection
     */
    public boolean removeAll(short startInclusive, short endInclusive) {
        checkRemoveModifiable();
        if (startInclusive > endInclusive) {
            return false;
        }
    ...
    /**
     * Adds a collection of <code>Short</code> values to this collection (optional operation).
     * <p>
     * This method is optional, throwing an UnsupportedOperationException if the
     * collection cannot be added to.
     * <p>
     * This implementation uses <code>addAll(short[])</code>.
     *
    ...
    protected Short toObject(short value) {
        return ShortUtils.toObject(value);
    }
    ...
    protected short toPrimitive(Object value) {
        return ShortUtils.toPrimitive(value);
    }
    ...
    protected short[] toPrimitiveArray(Collection<?> coll) {
        return ShortUtils.toPrimitiveArray(coll);
    }
