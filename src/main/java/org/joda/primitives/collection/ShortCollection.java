...
/**
 * Defines a collection of primitive <code>short</code> values.
 * <p>
 * This interface extends {@link java.util.Collection Collection} allowing
 * seamless integration with other APIs.
 * All Collection methods can be used, using the primitive wrapper class {@link Short}.
 ...
 * @since 1.0
 */
public interface ShortCollection extends PrimitiveCollection {
